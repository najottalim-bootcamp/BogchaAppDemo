...

{
    ...
    {
        public ValueTask<bool> CreateAsync(CreateAccident_RecordsDto accident_RecordsDto);
        public ValueTask<bool> UpdateAsync(int id,UpdateAccident_RecordsDto updateAccident_Records);
